...
namespace ConstantsLibrary
{
    ...
    public static class Constants
    {
        ...
        public static string CONFIG_FILE_INFO_USER = CONFIG + @"info.conf";
        public static string CONF_BLACK_LIST = CONFIG+@"blackList.conf";
		public static string CONF_DATABASES = CONFIG+@"databases.conf";
        public static string CONF_PUBLIC_KEY = CONFIG+@"publicKeyDaemon.pem";
        public static string CONF_PRIVATE_KEY = CONFIG + @"privateKeyDaemon.pem";

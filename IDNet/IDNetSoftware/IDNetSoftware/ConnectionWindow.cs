...
{
    public partial class ConnectionWindow : Gtk.Window
    {
         ...
         * */
        public ConnectionWindow(string source, string destination, string db_type, string db_name, Cripto keyPair) :
         ...
         * */
        public ConnectionWindow(string source, string destination, string db_type, string db_name,
